...
const App = () => {
    ...
    {
      brandLogo: "https://cdn.worldvectorlogo.com/logos/adobe-acrobat-dc-logo-2020.svg",
      companyName: "Adobe",
  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem,idx){
        return <div key={idx}>
          <Card logo = {elem.brandLogo} company = {elem.companyName} date = {elem.datePosted} post = {elem.post} tag1 = {elem.tag1} tag2 = {elem.tag2} sal = {elem.pay} location = {elem.location}/>
        </div>
      })}
    </div>
  )
